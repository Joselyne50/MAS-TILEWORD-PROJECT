...
import tileworld.agent.JoseAgent;
import tileworld.agent.Message;
import tileworld.agent.MyAgent;
import tileworld.agent.TimourAgent;
import tileworld.agent.MyAgentBen; //added by Ben
...
//        createAgent(new MyAgentBen(reward, "agent1", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
//        pos = this.generateRandomLocation();
        createAgent(new JoseAgent(reward, "agent2", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
//        pos = this.generateRandomLocation();
//        createAgent(new TimourAgent(reward, "agent3", pos.getX(), pos.getY(), this, Parameters.defaultFuelLevel));
////        
